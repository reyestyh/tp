 ...
 */
public class AddcCommandIntegrationTest {
    ...
    public void execute_newPerson_success() {
        ...
        assertCommandSuccess(new AddcCommand(validPerson), model,
                String.format(AddcCommand.MESSAGE_SUCCESS, Messages.format(validPerson)),
                expectedModel);
    }
