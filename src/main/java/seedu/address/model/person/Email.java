...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Invalid email: Please use the format LOCAL_PART@DOMAIN "
            + "and ensure:\n"
            ...
            + "    - Each domain label contains only alphanumeric characters, separated only by hyphens, if any.\n"
